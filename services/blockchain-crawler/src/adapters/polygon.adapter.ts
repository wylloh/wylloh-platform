...
export class PolygonAdapter extends BaseChainAdapter {
  public async processTransferEvent(event: any): Promise<TokenEvent> {
    try {
      ...
      logger.error('Error processing Polygon transfer event:', error);
      throw error;
    }
  }
  ...
  public async processListingEvent(event: any): Promise<ListingEvent> {
    try {
      ...
      logger.error('Error processing Polygon listing event:', error);
      throw error;
    }
  }
  ...
  public async processPurchaseEvent(event: any): Promise<PurchaseEvent> {
    try {
      ...
      logger.error('Error processing Polygon purchase event:', error);
      throw error;
    }
  }
  ...
  public async getTokenMetadata(tokenAddress: string, tokenId: string): Promise<Record<string, any>> {
    try {
      ...
      logger.error('Error getting Polygon token metadata:', error);
      throw error;
    }
  }
} 